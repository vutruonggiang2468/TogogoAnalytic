  ...
  return (
    <Tabs defaultValue="overview" className="space-y-4">
      <TabsList className="grid w-full grid-cols-4 bg-slate-800/60 border border-blue-400/30 p-1">
        <TabsTrigger
          value="overview"
          className="data-[state=active]:bg-blue-500/20 text-white data-[state=active]:text-cyan-400 text-sm py-2"
        >
            ...
            <CardContent className="p-6">
                    ...
                    <div className="p-3 bg-slate-700/30 rounded-lg">
                      ...
                      <div className="text-white">
                        {data?.company.charter_capital
                          ? Number(data.company.charter_capital).toLocaleString(
                              "vi-VN",
                              {
                                style: "currency",
                                currency: "VND",
              ...
              <div className="mt-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {stock.detailedInfo.businessActivities.keyProducts.map(
                    (product: string, index: number) => (
                      <Badge
                        key={index}
                        className="bg-emerald-500/20 text-emerald-400 border border-emerald-400/30 text-sm px-3 py-1"
                      >
                        {product}
                      </Badge>
                    )
          ...
          <Card className="bg-slate-800/60 border border-blue-400/30">
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {stock.detailedInfo.businessSegments.map(
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="p-4 bg-slate-700/30 rounded-lg">
                  ...
                  <div className="text-2xl font-bold text-white">
                    {stock.detailedInfo.financialHighlights.revenue}
                  </div>
                </div>
                ...
                <div className="p-4 bg-slate-700/30 rounded-lg">
                  ...
                  <div className="text-2xl font-bold text-emerald-400">
                    {stock.detailedInfo.financialHighlights.netIncome}
                  </div>
                </div>
                ...
                <div className="p-4 bg-slate-700/30 rounded-lg">
                  ...
                  <div className="text-2xl font-bold text-blue-400">
                    {stock.detailedInfo.financialHighlights.totalAssets}
                  </div>
                </div>
                ...
                <div className="p-4 bg-slate-700/30 rounded-lg">
                  ...
                  <div className="text-2xl font-bold text-purple-400">
                    {stock.detailedInfo.financialHighlights.profitMargin}
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="bg-slate-800/60 border border-blue-400/30">
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
                {(Object.entries(stock.performance) as [string, string][]).map(
                  ([period, value]) => (
                    <div
                      key={period}
        ...
        <TabsContent value="governance" className="space-y-6 mt-0">
          ...
          <Card className="bg-slate-800/60 border border-blue-400/30">
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {stock.detailedInfo.managementTeam.map(
                  (member: any, index: number) => (
                    <div key={index} className="p-4 bg-slate-700/30 rounded-lg">
                      ...
                      <div className="mt-3 text-sm text-slate-300 bg-slate-600/30 p-2 rounded-lg">
                        {member.background}
                      </div>
                    </div>
                  )
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Card className="bg-slate-800/60 border border-blue-400/30">
              <CardContent className="p-4">
                <h3 className="font-bold text-cyan-400 mb-3 flex items-center gap-2 text-base">
            ...
            <Card className="bg-slate-800/60 border border-blue-400/30">
              <CardContent className="p-4">
                ...
                <div className="space-y-2">
                  <Badge className="bg-emerald-500/20 text-emerald-400 text-sm w-full justify-center">
            ...
            <Card className="bg-slate-800/60 border border-blue-400/30">
              <CardContent className="p-4">
                ...
                <div className="space-y-2">
                  <Badge className="bg-yellow-500/20 text-yellow-400 text-sm w-full justify-center">
          ...
          <Card className="bg-slate-800/60 border border-blue-400/30">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-cyan-400 mb-4 flex items-center gap-2">
                ...
                <Badge
                  className={`${
                    stock?.detailedInfo.investment.recommendation === "MUA MẠNH"
                      ? "bg-emerald-500"
                      : stock?.detailedInfo.investment.recommendation === "MUA"
                      ? "bg-blue-500"
                      : "bg-yellow-500"
                  } text-white`}
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="text-center p-4 bg-gradient-to-br from-slate-700/30 to-emerald-500/20 rounded-lg">
                  <div className="text-base text-slate-400 mb-1 font-semibold">
                    Mục tiêu giá
                  </div>
                  <div className="text-2xl font-bold text-emerald-400 mb-1">
                    {stock?.detailedInfo.investment.priceTarget}
                  </div>
                  <Badge className="bg-emerald-500/20 text-emerald-400 text-sm">
                ...
                <div className="p-4 bg-slate-700/30 rounded-lg">
                  <div className="text-slate-400 text-base mb-2 font-semibold">
                    Khung thời gian
                  </div>
                  <div className="font-semibold text-white text-lg">
                    {stock?.detailedInfo.investment.timeHorizon}
                  </div>
                </div>
                ...
                <div className="p-4 bg-slate-700/30 rounded-lg">
                  ...
                  <div className="space-y-2">
                    {stock?.detailedInfo.investment.investmentThesis
                      .slice(0, 3)
                      .map((thesis: string, index: number) => (
                        <div
                          key={index}
            ...
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-cyan-400 mb-4 flex items-center gap-2">
                ...
                <Badge className="bg-blue-500/20 text-blue-400">
                  {stock?.detailedInfo.analystConsensus.totalAnalysts} chuyên
                  gia
                </Badge>
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-slate-700/30 rounded-lg">
                  ...
                  <div className="text-2xl font-bold text-blue-400">
                    {stock.detailedInfo.analystConsensus.avgPriceTarget}
                  </div>
                  <div className="text-sm text-slate-500 mt-1">
                    {stock.detailedInfo.analystConsensus.priceTargetLow} -{" "}
                    {stock.detailedInfo.analystConsensus.priceTargetHigh}
                  </div>
                </div>
                ...
                <div className="p-3 bg-emerald-500/20 rounded-lg text-center">
                  ...
                  <div className="text-emerald-400 font-bold text-xl">
                    {stock.detailedInfo.analystConsensus.strongBuy}
                  </div>
                </div>
                ...
                <div className="p-3 bg-blue-500/20 rounded-lg text-center">
                  ...
                  <div className="text-blue-400 font-bold text-xl">
                    {stock.detailedInfo.analystConsensus.buy}
                  </div>
                </div>
                ...
                <div className="p-3 bg-yellow-500/20 rounded-lg text-center">
                  ...
                  <div className="text-yellow-400 font-bold text-xl">
                    {stock.detailedInfo.analystConsensus.hold}
                  </div>
                </div>
              </div>
            </CardContent>
